...
namespace BPP.Cards
{
	internal class ArmsDealer : CustomCard
	{
		...
		{
			CardInfo cardInfo = Cards.instance.NORARITY_GetRandomCardWithCondition(player, gun, gunAmmo, data, health, gravity, block, characterStats, new Func<CardInfo, Player, Gun, GunAmmo, CharacterData, HealthHandler, Gravity, Block, CharacterStatModifiers, bool>(this.condition), 1000);
			...
			if (flag)
			{
				...
				cardInfo = Cards.instance.DrawRandomCardWithCondition(cardsToDrawFrom, player, null, null, null, null, null, null, null, new Func<CardInfo, Player, Gun, GunAmmo, CharacterData, HealthHandler, Gravity, Block, CharacterStatModifiers, bool>(this.condition), 1000);
			}
		...
		{
			return "Get a random <b>gun-related</b> card";
		}
