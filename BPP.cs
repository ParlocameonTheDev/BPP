...
namespace BPP
{
    ...
    [BepInPlugin("com.binarypenialporty.rounds.bpp", "BPP", "2.2.1")]
    ...
    public class BPP : BaseUnityPlugin
    {
        ...
        void Start()
        {
            ...
            Unbound.RegisterCredits("<b><color=#ffd900>BPP v2.2.1</b></color>", new string[]
            {
        ...
        private void NewGUI(GameObject menu)
        {
            ...
            MenuHandler.CreateText("You are playing with <b><color=#ffd900>BPP v2.2.1</b></color>", menu, out textMeshProUGUI, 20, true, null, null, null, null);
        }
